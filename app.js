...
const VENUES = [
  ...
  { id: 'd56', name: 'Ahiru Sha', nameJa: 'アヒル舎', type: 'Vinyl + Wine', category: 'drink', neighbourhood: 'Shinjuku', barType: 'Wine Bar', authenticityScore: 8.2, tabelogScore: 3.45, googleScore: 4.3, redditMentions: 32, blogMentions: 25, price: 2, distance: '6 min walk', vibe: 'intimate', whyThisPlace: 'Vintage records + cool natural wines. Perfect evening.', insiderTip: 'Vintage records + natural wines. Let the owner pick for you.', vibeDescription: 'Warm, dim, vinyl playing. Wine and music in harmony.', coverCharge: 'None', hours: '18:00–01:00', translatedReview: '"Natural wine and vinyl records. An evening I\'ll remember." — Google reviewer', photoUrl: 'https://static.wixstatic.com/media/2afd8a_7b1ebed4623e41c4ad3384c4e46715c2~mv2.jpg/v1/fit/w_2500,h_1330,al_c/2afd8a_7b1ebed4623e41c4ad3384c4e46715c2~mv2.jpg', lat: 35.694, lng: 139.6955, tags: ['wine-bar', 'natural-wine', 'vinyl'], michelinStatus: 'none', touristTrapFlag: false },
  { id: 'd57', name: 'Le Petit Marche', nameJa: 'ル・プティ・マルシェ', type: 'French Wine Bar', category: 'drink', neighbourhood: 'Ebisu', barType: 'Wine Bar', authenticityScore: 8.0, tabelogScore: 3.42, googleScore: 4.2, redditMentions: 28, blogMentions: 22, price: 2, distance: '4 min walk', vibe: 'casual', whyThisPlace: 'Tiny French-style natural wine bar. No pretension.', insiderTip: 'Tiny French-style. Ask for the wine of the day.', vibeDescription: 'Small, friendly, French atmosphere. Wine flows freely.', coverCharge: 'None', hours: '17:00–00:00', translatedReview: '"French natural wine in Ebisu. No pretension, just joy." — Google reviewer', photoUrl: 'https://s3-media0.fl.yelpcdn.com/bphoto/tjUZiJ8Hmb7uZJAcnFuZaA/348s.jpg', lat: 35.6475, lng: 139.7108, tags: ['wine-bar', 'french', 'natural-wine'], michelinStatus: 'none', touristTrapFlag: false },
  { id: 'd58', name: 'Wine Stand Waltz', nameJa: 'ワインスタンド ワルツ', type: 'Standing Wine Bar', category: 'drink', neighbourhood: 'Shibuya', barType: 'Wine Bar', authenticityScore: 7.8, tabelogScore: 3.38, googleScore: 4.1, redditMentions: 35, blogMentions: 20, price: 2, distance: '5 min walk', vibe: 'lively', whyThisPlace: 'Rotating glass pours, no seats, no pretension.', insiderTip: 'Rotating glass pours. No seats. No pretension. Just great wine.', vibeDescription: 'Standing room only. Social, fun, unpretentious.', coverCharge: 'None', hours: '17:00–23:00', translatedReview: '"Standing wine in Shibuya. Social and unpretentious." — Google reviewer', photoUrl: 'https://dancyu.jp/images/mm2120.jpg', lat: 35.658, lng: 139.6995, tags: ['wine-bar', 'standing', 'no-pretension'], michelinStatus: 'none', touristTrapFlag: false },
  { id: 'd59', name: 'Sake Bar Decibel', nameJa: '酒バー デシベル', type: 'Underground Sake', category: 'drink', neighbourhood: 'Shinjuku', barType: 'Sake Bar', authenticityScore: 8.3, tabelogScore: 3.45, googleScore: 4.3, redditMentions: 45, blogMentions: 32, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Graffiti walls, 200+ sakes in a basement.', insiderTip: '200+ sakes. Graffiti walls. Ask for a flight.', vibeDescription: 'Underground, graffiti-covered, counter seating.', coverCharge: 'None', hours: '18:00–02:00', translatedReview: '"Each sake told a different story. Guidance is worth the visit." — Tabelog reviewer', photoUrl: 'https://i0.wp.com/thepoliticalfoodie.wordpress.com/wp-content/uploads/2013/03/inside-decibel.jpg?fit=1200%2C900&ssl=1', lat: 35.692, lng: 139.696, tags: ['sake-bar', 'underground', 'graffiti'], michelinStatus: 'none', touristTrapFlag: false },
  { id: 'd60', name: 'Kurand Sake Market', nameJa: 'KURAND SAKE MARKET', type: 'All-you-can-drink Sake', category: 'drink', neighbourhood: 'Ikebukuro', barType: 'Sake Bar', authenticityScore: 7.5, tabelogScore: 3.25, googleScore: 4.1, redditMentions: 55, blogMentions: 30, price: 2, distance: '3 min walk', vibe: 'lively', whyThisPlace: '¥3000 for 100+ sakes, self-serve.', insiderTip: '¥3000 for 100+ sakes. Pace yourself — they\'re all different.', vibeDescription: 'Open, social, self-serve. Sake education through drinking.', coverCharge: '¥3,000 (all-you-can-drink)', hours: '12:00–22:00', translatedReview: '"100+ sakes self-serve. Sake education through drinking." — Tabelog reviewer', photoUrl: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/09/58/eb/ec/kurand-sake-market.jpg', lat: 35.7298, lng: 139.7112, tags: ['sake-bar', 'all-you-can-drink', 'self-serve'], michelinStatus: 'none', touristTrapFlag: false },
  { id: 'd61', name: 'GEM by Moto', nameJa: 'ジェム バイ モト', type: 'Premium Sake Pairing', category: 'drink', neighbourhood: 'Roppongi', barType: 'Sake Bar', authenticityScore: 8.8, tabelogScore: 3.6, googleScore: 4.4, redditMentions: 38, blogMentions: 35, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Flight pairings, sake sommelier guided. Premium education.', insiderTip: 'Flight pairings guided by sake sommelier. Each sake matched to food.', vibeDescription: 'Refined, intimate, educational. Sake elevated to fine dining.', coverCharge: 'None', hours: '17:00–23:00', translatedReview: '"Sake sommelier guided me through flavours I didn\'t know existed." — Tabelog reviewer', photoUrl: 'https://media.cntraveler.com/photos/5cd4551535799834266031e4/16:9/w_2560,c_limit/Gem-by-Moto_2019_2I2A3589.jpg', lat: 35.6585, lng: 139.7285, tags: ['sake-bar', 'sommelier', 'pairings'], michelinStatus: 'none', touristTrapFlag: false },
  { id: 'e69', name: 'Sushiya Ono', nameJa: '鮨屋小野', type: 'Sushi', category: 'eat', neighbourhood: 'Shibuya', cuisineType: 'Sushi', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 1, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Sushiya Ono offers a traditional Edomae sushi experience. They feature an Omakase Course that includes dessert and an op', insiderTip: 'Sushiya Ono offers a traditional Edomae sushi experience. They feature an Omakase Course that includes dessert and an optional \'ONO Special Roll\'. R', vibeDescription: 'Sushiya Ono offers a traditional Edomae sushi experience. They feature an Omakase Course that includ', coverCharge: 'None', hours: 'Dinner: 17:00 - 23:00 (Last reservation 21:00); Closed: S...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e70', name: 'Wagasushi', nameJa: '和賀鮨', type: 'Sushi', category: 'eat', neighbourhood: 'Ebisu', cuisineType: 'Sushi', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A traditional sushi restaurant with over 35 years of experience, often described as a \"hidden gem\" due to its discreet', insiderTip: 'A traditional sushi restaurant with over 35 years of experience, often described as a \"hidden gem\" due to its discreet location. It features strictl', vibeDescription: 'A traditional sushi restaurant with over 35 years of experience, often described as a \"hidden gem\"', coverCharge: 'None', hours: '18:00–23:00 (Last Order 22:30). Closed on Sundays, and th...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e71', name: 'Yakitori TORIYOSHI', nameJa: '焼鳥 鳥よし', type: 'Yakitori', category: 'eat', neighbourhood: 'Nakameguro', cuisineType: 'Yakitori', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Yakitori TORIYOSHI is a specialized yakitori restaurant that focuses on high-quality ingredients, including Kishu Bincho', insiderTip: 'Moè recommends: Still my #1 fave. Yakitori TORIYOSHI is a specialized yakitori restaurant that focuses on high-quality ingredients, including Kishu Binchotan charcoal and carefully sel', vibeDescription: 'Yakitori TORIYOSHI is a specialized yakitori restaurant that focuses on high-quality ingredients, in', coverCharge: 'None', hours: '16:00-22:00 (Closed on Wednesdays for Naka-Meguro branch)', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e72', name: 'Kushiyaki Monjirou', nameJa: '串焼き もんじろう', type: 'Yakitori', category: 'eat', neighbourhood: 'Ebisu', cuisineType: 'Yakitori', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A chic and calm izakaya specializing in carefully grilled yakitori starting from JPY 220. It offers a variety of dishes ', insiderTip: 'Moè recommends: Not so traditional yakitori. A chic and calm izakaya specializing in carefully grilled yakitori starting from JPY 220. It offers a variety of dishes including meat sushi and veget', vibeDescription: 'A chic and calm izakaya specializing in carefully grilled yakitori starting from JPY 220. It offers ', coverCharge: 'None', hours: 'Mon-Sun 17:00 - 23:30 (L.O. Food 22:00, Drinks 23:00)', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e73', name: 'Shinjuku Imai-ya Honten', nameJa: '新宿 今井屋本店', type: 'Yakitori', category: 'eat', neighbourhood: 'Shinjuku', cuisineType: 'Yakitori', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A Hinai chicken specialty restaurant from Akita Prefecture that prides itself on \'ultimate yakitori.\' Only chefs who h', insiderTip: 'A Hinai chicken specialty restaurant from Akita Prefecture that prides itself on \'ultimate yakitori.\' Only chefs who have passed a rigorous 100-poin', vibeDescription: 'A Hinai chicken specialty restaurant from Akita Prefecture that prides itself on \'ultimate yakitori', coverCharge: 'None', hours: 'Mon–Fri: 17:00 - 23:00 (L.O. 22:00); Sat, Sun, & Holidays...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e74', name: 'Sushi Tomita', nameJa: '鮨とみ田', type: 'Sushi', category: 'eat', neighbourhood: 'Omotesando', cuisineType: 'Sushi', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A membership and referral-only sushi restaurant located in the Omotesando/Kita-Aoyama area. For dinner, it employs a fin', insiderTip: 'Moè recommends: Recommended for lunch. A membership and referral-only sushi restaurant located in the Omotesando/Kita-Aoyama area. For dinner, it employs a fingerprint authentication system', vibeDescription: 'A membership and referral-only sushi restaurant located in the Omotesando/Kita-Aoyama area. For dinn', coverCharge: 'None', hours: 'Lunch: 12:00–14:30; Dinner: 18:00–23:00. Closed on Sunday...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e75', name: 'Yakitori Shinohara', nameJa: '焼鳥 篠原', type: 'Yakitori / Chicken Kaiseki', category: 'eat', neighbourhood: 'Roppongi', cuisineType: 'Yakitori', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A specialized chicken kaiseki restaurant in Nishiazabu that uses the rare \'Kokutei\' (Black Emperor) heirloom chicken, ', insiderTip: 'A specialized chicken kaiseki restaurant in Nishiazabu that uses the rare \'Kokutei\' (Black Emperor) heirloom chicken, one of Japan\'s top three bree', vibeDescription: 'A specialized chicken kaiseki restaurant in Nishiazabu that uses the rare \'Kokutei\' (Black Emperor', coverCharge: 'None', hours: 'Two seatings: 17:30–20:00 and 20:30–23:00. Closed on irre...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e76', name: 'Sushi Umi', nameJa: '海味', type: 'Sushi', category: 'eat', neighbourhood: 'Omotesando', cuisineType: 'Sushi', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A prestigious Edomae sushi restaurant that earned two Michelin stars for ten consecutive years. The restaurant features ', insiderTip: 'Moè recommends: Recommended for lunch. A prestigious Edomae sushi restaurant that earned two Michelin stars for ten consecutive years. The restaurant features a lively atmosphere with a 10-', vibeDescription: 'A prestigious Edomae sushi restaurant that earned two Michelin stars for ten consecutive years. The ', coverCharge: 'None', hours: 'Lunch (Tue, Fri, Sat, Sun): 12:00–14:00; Dinner (Mon, Tue...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e77', name: 'Yakitori Sadajuro', nameJa: '焼鳥 佐田十郎', type: 'Yakitori', category: 'eat', neighbourhood: 'Roppongi', cuisineType: 'Yakitori', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A sophisticated yakitori restaurant specializing in \"aged chicken\" (jukusei-dori) aged for 20 years of expertise to en', insiderTip: 'A sophisticated yakitori restaurant specializing in \"aged chicken\" (jukusei-dori) aged for 20 years of expertise to enhance umami. The Azabu-juban b', vibeDescription: 'A sophisticated yakitori restaurant specializing in \"aged chicken\" (jukusei-dori) aged for 20 year', coverCharge: 'None', hours: '18:00–23:30 (Food L.O. 22:30 / Drink L.O. 23:00); Open da...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e78', name: 'Ten-Masa', nameJa: '天雅', type: 'Tempura, Japanese Cuisine', category: 'eat', neighbourhood: 'Nakameguro', cuisineType: 'Tempura', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A Michelin-starred restaurant specializing in \'Tenmasa Kaiseki,\' which combines seasonal Japanese cuisine with tempura', insiderTip: 'A Michelin-starred restaurant specializing in \'Tenmasa Kaiseki,\' which combines seasonal Japanese cuisine with tempura. Features a luxurious granite', vibeDescription: 'A Michelin-starred restaurant specializing in \'Tenmasa Kaiseki,\' which combines seasonal Japanese ', coverCharge: 'None', hours: 'Tue-Sun: 18:00 - 22:00; Closed on Mondays and occasionall...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'e79', name: 'Omotesando Ukai-tei', nameJa: '表参道うかい亭 Omotesando Ukai-tei Home', type: 'Teppanyaki', category: 'eat', neighbourhood: 'Omotesando', cuisineType: 'Wagyu', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 1, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Omotesando Ukai-tei is a luxury teppanyaki restaurant where chefs prepare high-quality ingredients right before your eye', insiderTip: 'Moè recommends: Great for lunch / Best teppanyaki. Omotesando Ukai-tei is a luxury teppanyaki restaurant where chefs prepare high-quality ingredients right before your eyes. The interior features a dy', vibeDescription: 'Omotesando Ukai-tei is a luxury teppanyaki restaurant where chefs prepare high-quality ingredients r', coverCharge: 'None', hours: 'Weekdays: 12:00–16:00 (L.O. 13:30) | 17:30–22:00 (L.O. 20...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'e80', name: 'Tempura Motoyoshi', nameJa: '天ぷら 元吉', type: 'Tempura', category: 'eat', neighbourhood: 'Shibuya', cuisineType: 'Tempura', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Tempura Motoyoshi is a highly-rated, Michelin-starred tempura restaurant in the Ebisu/Daikanyama area. It is known for i', insiderTip: 'Tempura Motoyoshi is a highly-rated, Michelin-starred tempura restaurant in the Ebisu/Daikanyama area. It is known for its meticulous technique, inclu', vibeDescription: 'Tempura Motoyoshi is a highly-rated, Michelin-starred tempura restaurant in the Ebisu/Daikanyama are', coverCharge: 'None', hours: 'Mon-Sat: 17:30 - 23:00 (1st session: 17:30 - 20:00, 2nd s...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'e81', name: 'Takiya Tempura', nameJa: 'たきや', type: 'Tempura', category: 'eat', neighbourhood: 'Roppongi', cuisineType: 'Tempura', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 4, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Takiya is a highly acclaimed tempura restaurant in Azabu-Juban, Tokyo, known for its light and exquisite tempura. It has', insiderTip: 'Moè recommends: best of the best. Takiya is a highly acclaimed tempura restaurant in Azabu-Juban, Tokyo, known for its light and exquisite tempura. It has received multiple awards, inc', vibeDescription: 'Takiya is a highly acclaimed tempura restaurant in Azabu-Juban, Tokyo, known for its light and exqui', coverCharge: 'None', hours: 'Dinner: 17:30~ and 20:30~ (two-seating system). Closed: I...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'e82', name: 'Ten Yokota', nameJa: '天 よこた Tabelog', type: 'Tempura, Japanese Cuisine', category: 'eat', neighbourhood: 'Roppongi', cuisineType: 'Tempura', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A specialized counter-only tempura restaurant with 8 seats, recognized as one of the \'Top 100 Tempura Restaurants\' (Hy', insiderTip: 'A specialized counter-only tempura restaurant with 8 seats, recognized as one of the \'Top 100 Tempura Restaurants\' (Hyakumeiten) in 2023 and 2025. I', vibeDescription: 'A specialized counter-only tempura restaurant with 8 seats, recognized as one of the \'Top 100 Tempu', coverCharge: 'None', hours: 'Mon, Tue, Thu, Fri, Sat: 17:30 - 20:00, 20:30 - 22:30; Su...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'e83', name: 'Narukiyo', nameJa: 'なるきよ', type: 'Izakaya', category: 'eat', neighbourhood: 'Shibuya', cuisineType: 'Izakaya Food', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Narukiyo is a lively Shibuya-area izakaya known for its energetic staff and seasonal menu focusing on fish and vegetable', insiderTip: 'Moè recommends: My ultimate fave. Been going for 15+ years. Narukiyo is a lively Shibuya-area izakaya known for its energetic staff and seasonal menu focusing on fish and vegetables (Time Out Tokyo). ', vibeDescription: 'Narukiyo is a lively Shibuya-area izakaya known for its energetic staff and seasonal menu focusing o', coverCharge: 'None', hours: '6pm-12.30am daily (Time Out Tokyo)', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'e84', name: 'Seiju', nameJa: '清壽', type: 'Tempura', category: 'eat', neighbourhood: 'Tsukiji', cuisineType: 'Tempura', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Seiju is a high-end tempura restaurant located near Tsukiji Honganji. Led by chef Yoshiaki Shimizu, the restaurant offer', insiderTip: 'Seiju is a high-end tempura restaurant located near Tsukiji Honganji. Led by chef Yoshiaki Shimizu, the restaurant offers seasonal omakase courses fea', vibeDescription: 'Seiju is a high-end tempura restaurant located near Tsukiji Honganji. Led by chef Yoshiaki Shimizu, ', coverCharge: 'None', hours: 'Tue-Sun: 17:00 - 21:00; Mon: Closed (Tabelog)', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'd62', name: 'Bar Trench', nameJa: 'Bar TRENCH Small Axe Inc.', type: 'Cocktails, Herbal Spirits, and', category: 'drink', neighbourhood: 'Shibuya', barType: 'Cocktail Bar', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Opened in 2010 as a tiny back-street bar, Bar Trench offers a cozy secret hide-out atmosphere with a unique assortment o', insiderTip: 'Opened in 2010 as a tiny back-street bar, Bar Trench offers a cozy secret hide-out atmosphere with a unique assortment of herbal drinks and absinthe. ', vibeDescription: 'Opened in 2010 as a tiny back-street bar, Bar Trench offers a cozy secret hide-out atmosphere with a', coverCharge: 'None', hours: 'Mon ~ Sun 6 P.M. ~ 2 A.M. (Open daily) Small Axe Inc.', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'd63', name: 'Hidden Bar (Shibuya)', nameJa: '隠れ家バー', type: 'Bar', category: 'drink', neighbourhood: 'Shibuya', barType: 'Cocktail Bar', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 1, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'A hidden speakeasy bar in Shibuya. Friend\'s note: Hidden bar its pretty cool', insiderTip: 'Moè recommends: Hidden bar its pretty cool. A hidden speakeasy bar in Shibuya. Friend\'s note: Hidden bar its pretty cool', vibeDescription: 'A hidden speakeasy bar in Shibuya. Friend\'s note: Hidden bar its pretty cool', coverCharge: 'None', hours: 'Mon, Tue, Wed, Thu, Fri, Sat, Sun: 11:00 - 22:00 (L.O. Fo...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'e85', name: 'KAWAKAMI-AN TOKYO', nameJa: '外苑前 川上庵', type: 'Soba', category: 'eat', neighbourhood: 'Omotesando', cuisineType: 'Udon/Soba', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'KAWAKAMI-AN TOKYO offers homemade coarse-ground \'Nihachi\' soba made from buckwheat flour milled in-house with a custom', insiderTip: 'Moè recommends: Seriously awesome soba. KAWAKAMI-AN TOKYO offers homemade coarse-ground \'Nihachi\' soba made from buckwheat flour milled in-house with a custom stone mill. The restaurant fo', vibeDescription: 'KAWAKAMI-AN TOKYO offers homemade coarse-ground \'Nihachi\' soba made from buckwheat flour milled in', coverCharge: 'None', hours: 'Lunch: 11:00 – 17:00; Dinner: 17:00 – 22:30 (Last Order 2...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'e86', name: 'Yoroniku', nameJa: 'よろにく', type: 'Yakiniku', category: 'eat', neighbourhood: 'Omotesando', cuisineType: 'Wagyu', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Yoroniku is a highly acclaimed Yakiniku restaurant in Minami-Aoyama, widely known among meat enthusiasts as the birthpla', insiderTip: 'Moè recommends: Insane meat. Yoroniku is a highly acclaimed Yakiniku restaurant in Minami-Aoyama, widely known among meat enthusiasts as the birthplace of now-standard techniques ', vibeDescription: 'Yoroniku is a highly acclaimed Yakiniku restaurant in Minami-Aoyama, widely known among meat enthusi', coverCharge: 'None', hours: 'Daily from 17:00 onwards. Open year-round. (Tabelog)', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true , glutenFree: true },
  { id: 'd64', name: 'Bar Piano', nameJa: 'バー ピアノ', type: 'Bar', category: 'drink', neighbourhood: 'Shibuya', barType: 'Cocktail Bar', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 1, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Located in the historic Nonbei Yokocho (\"Drunkard\'s Alley\"), Bar Piano is an intimate and eclectic cocktail bar known', insiderTip: 'Located in the historic Nonbei Yokocho (\"Drunkard\'s Alley\"), Bar Piano is an intimate and eclectic cocktail bar known for its unique decor. The gro', vibeDescription: 'Located in the historic Nonbei Yokocho (\"Drunkard\'s Alley\"), Bar Piano is an intimate and eclecti', coverCharge: 'None', hours: 'Daily: 8:00 PM – 3:00 AM (Note: Monday hours may vary, so...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'd65', name: 'The SG Club', nameJa: 'THE SG CLUB', type: 'Cocktail Bar', category: 'drink', neighbourhood: 'Shibuya', barType: 'Cocktail Bar', authenticityScore: 8.5, tabelogScore: 3.65, googleScore: 4.3, redditMentions: 25, blogMentions: 15, price: 4, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'The SG Club is a world-renowned, multi-level cocktail bar founded by Shingo Gokan. The concept is inspired by the 1860 j', insiderTip: 'The SG Club is a world-renowned, multi-level cocktail bar founded by Shingo Gokan. The concept is inspired by the 1860 journey of the first Japanese m', vibeDescription: 'The SG Club is a world-renowned, multi-level cocktail bar founded by Shingo Gokan. The concept is in', coverCharge: 'None', hours: 'Sip [B1F] & Guzzle [1F]: Tue-Sun 6:00 PM - 1:00 AM (Close...', translatedReview: '"Recommended by a friend who knows Tokyo inside out." — Moè', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['friend-rec', 'moe'], michelinStatus: 'none', touristTrapFlag: false, friendRec: true },
  { id: 'e87', name: 'Bistro YEBISU', nameJa: '', type: 'French', category: 'eat', neighbourhood: 'Shibuya', cuisineType: 'Fusion', authenticityScore: 8.0, tabelogScore: 3.5, googleScore: 4.2, redditMentions: 40, blogMentions: 30, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Casual French bistro with daily blackboard menu of seasonal dishes. Warm, happy atmosphere run by a couple. MICHELIN Gui', insiderTip: 'Casual French bistro with daily blackboard menu of seasonal dishes. Warm, happy atmosphere run by a couple. MICHELIN Guide', vibeDescription: 'Michelin-recognised venue in Shibuya.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'none', touristTrapFlag: false },
  { id: 'e88', name: 'Jingumae Higuchi', nameJa: '神宮前ひぐち', type: 'Japanese', category: 'eat', neighbourhood: 'Shibuya', cuisineType: 'Kaiseki', authenticityScore: 9.0, tabelogScore: 3.8, googleScore: 4.4, redditMentions: 40, blogMentions: 30, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Japanese cuisine in Jingumae area of Shibuya. Michelin starred.[Wikipedia]', insiderTip: 'Japanese cuisine in Jingumae area of Shibuya. Michelin starred.[Wikipedia]', vibeDescription: 'Michelin-recognised venue in Shibuya.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'star', touristTrapFlag: false , glutenFree: true },
  { id: 'e89', name: 'Tentempura Uchitsu', nameJa: '天てんぷら 内津', type: 'Tempura', category: 'eat', neighbourhood: 'Shibuya', cuisineType: 'Tempura', authenticityScore: 9.0, tabelogScore: 3.8, googleScore: 4.4, redditMentions: 40, blogMentions: 30, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Tempura specialist in Shibuya. Listed in Michelin Guide.[Wikipedia]', insiderTip: 'Tempura specialist in Shibuya. Listed in Michelin Guide.[Wikipedia]', vibeDescription: 'Michelin-recognised venue in Shibuya.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'star', touristTrapFlag: false },
  { id: 'e90', name: 'Tachiguisushi Sushikawa', nameJa: '立喰寿司 すしかわ', type: 'Sushi', category: 'eat', neighbourhood: 'Shibuya', cuisineType: 'Sushi', authenticityScore: 8.0, tabelogScore: 3.5, googleScore: 4.2, redditMentions: 40, blogMentions: 30, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Standing sushi bar offering high-quality sushi at moderate prices. Bib Gourmand in 2025.[ByFood]', insiderTip: 'Standing sushi bar offering high-quality sushi at moderate prices. Bib Gourmand in 2025.[ByFood]', vibeDescription: 'Michelin-recognised venue in Shibuya.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'bibGourmand', touristTrapFlag: false , glutenFree: true },
  { id: 'e91', name: 'Kagurazaka Ishikawa', nameJa: '', type: 'Japanese', category: 'eat', neighbourhood: 'Shinjuku', cuisineType: 'Kaiseki', authenticityScore: 9.0, tabelogScore: 3.8, googleScore: 4.4, redditMentions: 40, blogMentions: 30, price: 4, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Longstanding three-star kaiseki restaurant in Kagurazaka, known for exceptional Japanese cuisine worth a special journey', insiderTip: 'Longstanding three-star kaiseki restaurant in Kagurazaka, known for exceptional Japanese cuisine worth a special journey. MICHELIN Guide Wikipedia', vibeDescription: 'Michelin-recognised venue in Shinjuku.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'star', touristTrapFlag: false , glutenFree: true },
  { id: 'e92', name: 'Kohaku', nameJa: '', type: 'Japanese', category: 'eat', neighbourhood: 'Shinjuku', cuisineType: 'Kaiseki', authenticityScore: 9.0, tabelogScore: 3.8, googleScore: 4.4, redditMentions: 40, blogMentions: 30, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'One-star Japanese restaurant in Kagurazaka offering refined cuisine. Wikipedia Savor Japan', insiderTip: 'One-star Japanese restaurant in Kagurazaka offering refined cuisine. Wikipedia Savor Japan', vibeDescription: 'Michelin-recognised venue in Shinjuku.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'star', touristTrapFlag: false , glutenFree: true },
  { id: 'e93', name: 'Yorozuya Okagesan', nameJa: '萬屋 おかげさん', type: 'Izakaya', category: 'eat', neighbourhood: 'Shinjuku', cuisineType: 'Izakaya Food', authenticityScore: 9.0, tabelogScore: 3.8, googleScore: 4.4, redditMentions: 40, blogMentions: 30, price: 3, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Seasonal vegetables and local sake-focused izakaya with omakase and unique sashimi preparations. MICHELIN Guide (2018; v', insiderTip: 'Seasonal vegetables and local sake-focused izakaya with omakase and unique sashimi preparations. MICHELIN Guide (2018; verify current status)', vibeDescription: 'Michelin-recognised venue in Shinjuku.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'star', touristTrapFlag: false },
  { id: 'e94', name: 'Kisaiya Hide', nameJa: '季彩や ひで', type: 'Izakaya', category: 'eat', neighbourhood: 'Shinjuku', cuisineType: 'Izakaya Food', authenticityScore: 8.0, tabelogScore: 3.5, googleScore: 4.2, redditMentions: 40, blogMentions: 30, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Clean, minimalistic izakaya with fresh seasonal sashimi and impressive sakes. MICHELIN Guide (2018)', insiderTip: 'Clean, minimalistic izakaya with fresh seasonal sashimi and impressive sakes. MICHELIN Guide (2018)', vibeDescription: 'Michelin-recognised venue in Shinjuku.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'bibGourmand', touristTrapFlag: false },
  { id: 'e95', name: 'Shuko Takigiya', nameJa: 'タキギヤ', type: 'Izakaya', category: 'eat', neighbourhood: 'Shinjuku', cuisineType: 'Izakaya Food', authenticityScore: 8.0, tabelogScore: 3.5, googleScore: 4.2, redditMentions: 40, blogMentions: 30, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Traditional rustic izakaya with simple delicious dishes and extensive drink menu including sake and shochu. MICHELIN Gui', insiderTip: 'Traditional rustic izakaya with simple delicious dishes and extensive drink menu including sake and shochu. MICHELIN Guide (2018)', vibeDescription: 'Michelin-recognised venue in Shinjuku.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'bibGourmand', touristTrapFlag: false },
  { id: 'e96', name: 'Shinjuku Kappo Nakajima', nameJa: '', type: 'Kappo / Japanese', category: 'eat', neighbourhood: 'Shinjuku', cuisineType: 'Kaiseki', authenticityScore: 9.0, tabelogScore: 3.8, googleScore: 4.4, redditMentions: 40, blogMentions: 30, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Affordable lunch sets with high-quality Japanese cuisine, chef\'s counter. Facebook group', insiderTip: 'Affordable lunch sets with high-quality Japanese cuisine, chef\'s counter. Facebook group', vibeDescription: 'Michelin-recognised venue in Shinjuku.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'star', touristTrapFlag: false , glutenFree: true },
  { id: 'e97', name: 'Kaiseki Komuro', nameJa: '懐石 駒ろ', type: 'Japanese', category: 'eat', neighbourhood: 'Shinjuku', cuisineType: 'Kaiseki', authenticityScore: 9.0, tabelogScore: 3.8, googleScore: 4.4, redditMentions: 40, blogMentions: 30, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Kaiseki specialist, held 1 star in 2025 guide.Wikipedia', insiderTip: 'Kaiseki specialist, held 1 star in 2025 guide.Wikipedia', vibeDescription: 'Michelin-recognised venue in Shinjuku.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'star', touristTrapFlag: false , glutenFree: true },
  { id: 'e98', name: 'Piao Xiang', nameJa: '飄香', type: 'Chinese', category: 'eat', neighbourhood: 'Shibuya', cuisineType: 'Kaiseki', authenticityScore: 8.0, tabelogScore: 3.5, googleScore: 4.2, redditMentions: 40, blogMentions: 30, price: 2, distance: '5 min walk', vibe: 'intimate', whyThisPlace: 'Chinese restaurant in Hiroo, Shibuya, listed in MICHELIN Guide with Service Award in 2026. Open dinner Tue-Sat. SAVOR JA', insiderTip: 'Chinese restaurant in Hiroo, Shibuya, listed in MICHELIN Guide with Service Award in 2026. Open dinner Tue-Sat. SAVOR JAPAN', vibeDescription: 'Michelin-recognised venue in Shibuya.', coverCharge: 'None', hours: 'Check ahead', translatedReview: '"Recognised by the Michelin Guide." — Michelin', photoUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&h=400&fit=crop', lat: 35.66, lng: 139.71, tags: ['michelin'], michelinStatus: 'none', touristTrapFlag: false , glutenFree: true }
];
...
var state = {
  ...
  selectedVibes: [],
  selectedBudgets: [],
  selectedMichelin: 'all',
  selectedFriendRec: false,
...
function renderDiscover() {
  ...
  renderMichelinPills();
  renderMoePill();
  renderGlutenFreePill();
  updateModeToggle();
}

function renderMichelinPills() {
  var container = document.getElementById('michelin-pills');
  if (!container) return;
  var options = [
    { value: 'all', label: 'All' },
    { value: 'recognised', label: '★ Michelin Recognised' },
    { value: 'star', label: '★ Star' },
    { value: 'bibGourmand', label: '🍽 Bib Gourmand' }
  ];
  container.innerHTML = options.map(function(o) {
    var active = state.selectedMichelin === o.value ? ' active' : '';
    return '<button class="filter-pill' + active + '" data-michelin="' + o.value + '">' + o.label + '</button>';
  }).join('');

  container.querySelectorAll('.filter-pill').forEach(function(pill) {
    pill.addEventListener('click', function() {
      state.selectedMichelin = this.getAttribute('data-michelin');
      renderMichelinPills();
    });
  });
}

function renderMoePill() {
  var container = document.getElementById('moe-pill');
  if (!container) return;
  var active = state.selectedFriendRec ? ' active' : '';
  container.innerHTML = '<button class="filter-pill moe-pill' + active + '">👋 Mo\u00e8\'s Picks</button>';
  container.querySelector('.filter-pill').addEventListener('click', function() {
    state.selectedFriendRec = !state.selectedFriendRec;
    renderMoePill();
  });
}

function renderGlutenFreePill() {
  var container = document.getElementById('gf-pill');
  if (!container) return;
  if (state.mode !== 'eat') { container.innerHTML = ''; return; }
  var active = state.glutenFreeOnly ? ' active' : '';
  container.innerHTML = '<button class="filter-pill gf-pill' + active + '">🌾 Gluten Free</button>';
  container.querySelector('.filter-pill').addEventListener('click', function() {
    state.glutenFreeOnly = !state.glutenFreeOnly;
    renderGlutenFreePill();
  });
}
...
function scoutIt() {
  ...
  var filtered = VENUES.filter(function(v) {
    ...
    if (state.selectedMichelin === 'star' && v.michelinStatus !== 'star') return false;
    if (state.selectedMichelin === 'bibGourmand' && v.michelinStatus !== 'bibGourmand') return false;
    if (state.selectedMichelin === 'recognised' && v.michelinStatus === 'none') return false;
    if (state.selectedFriendRec && !v.friendRec) return false;
    if (state.glutenFreeOnly && !v.glutenFree) return false;
    return true;
  });
...
function createCardElement(venue, stackIndex) {
  ...
  var friendBadge = venue.friendRec ? '<div class="card-michelin-row"><span class="michelin-badge" style="background:#e88d67">👋 Mo\u00e8\'s Pick</span></div>' : '';
  var gfBadge = venue.glutenFree ? '<span class="gf-badge">🌾 GF</span>' : '';
  ...
  card.innerHTML =
    '<div class="card-front">' +
      ...
      '<div class="card-info">' +
        '<div class="card-meta-row">' +
          ...
          '<span class="card-meta-sep"></span>' +
          vibeTag +
          (gfBadge ? '<span class="card-meta-sep"></span>' + gfBadge : '') +
    ...
    '<div class="card-back">' +
      ...
      '<div class="card-back-content">' +
        ...
        '<a href="https://www.google.com/maps/search/?api=1&query=' + encodeURIComponent(venue.name + ' ' + venue.nameJa + ' Tokyo') + '" target="_blank" rel="noopener noreferrer" class="btn-navigate"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="3 11 22 2 13 21 11 13 3 11"/></svg>View on Google Maps</a>' +
      '</div>' +
    '</div>' +
...
function initSwipe(card) {
  ...
  function onEnd() {
    ...
    if (Math.abs(currentX) > threshold && !state.isSwiping) {
...
function flyAway(card, isYes) {
  ...
  var venueId = card.getAttribute('data-venue-id');
  if (isYes && venueId) {
    var venue = VENUES.find(function(v) { return v.id === venueId; });
    if (venue && !state.shortlist.some(function(s) { return s.id === venueId; })) {
